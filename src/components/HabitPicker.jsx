      ...
      {open && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end">
          ...
          <div className="relative bg-white rounded-t-3xl pb-safe overflow-hidden">
            ...
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide px-5 mb-2">Switch Habit</p>
            ...
            <div className="border-t border-gray-100 mt-1">
              {adding ? (
                    ...
                    {COLORS.map(c => (
                      <button key={c.id} onClick={() => setNewColor(c.id)}
                        ...
                        style={{ background: c.hex,
                          ...
                          boxShadow: newColor === c.id ? `0 0 0 3px white, 0 0 0 5px ${c.hex}` : 'none' }} />
                    ))}
                  </div>
                  <div className="flex gap-2">
                ...
                <button onClick={() => setAdding(true)}
                  ...
                  <span className="text-base font-medium">New Habit</span>
                </button>
              )}
            </div>
          </div>
